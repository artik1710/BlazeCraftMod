...
public class BlazeFurnaceRecipes 
{	
	private static final BlazeFurnaceRecipes INSTANCE = new BlazeFurnaceRecipes();
	private final Table<ItemStack, ItemStack, ItemStack> smeltingList = HashBasedTable.<ItemStack, ItemStack, ItemStack>create();
	private final Map<ItemStack, Float> experienceList = Maps.<ItemStack, Float>newHashMap();
	
	public static BlazeFurnaceRecipes getInstance()
	{
		return INSTANCE;
	}
	
	private BlazeFurnaceRecipes() 
	{
		addBlazeRecipe(new ItemStack(Items.COAL), new ItemStack(MainRegistry.ItemCumball), new ItemStack(Items.SLIME_BALL), 5.0F);
	...
	public void addBlazeRecipe(ItemStack input1, ItemStack input2, ItemStack result, float experience) 
	{
